...
-- Please note permission changes here require a Hyprland restart and ar/pengerse not applied on-the-fly
...
hl.on("config.reloaded", function()
    hl.exec_cmd("gsettings set org.gnome.desktop.interface font-name 'JetBrains Mono Nerd Font 10'")
end)
